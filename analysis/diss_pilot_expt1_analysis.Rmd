...
v2NumCols <- c("effectivenessRestudy_num", 
...
summary(lm(changeRelativeToOutcome_num ~ diff_interventionTestOutcomeRG, df_v2n48_v3n36_users)) # 0.0007441
summary(lm(changeRelativeToOutcome_num ~ abs(diff_interventionTestOutcomeRG), df_v2n48_v3n36_users)) # 0.1011

summary(lm(changeRelativeToOutcome_num ~ diff_interventionRestudyScoreToPrediction, df_v2n48_v3n36_users)) # 0.4
summary(lm(changeRelativeToOutcome_num ~ diff_interventionGenerateScoreToPrediction, df_v2n48_v3n36_users)) # 0.6262
summary(lm(changeRelativeToOutcome_num ~ diff_interventionRestudyScoreToPrediction + diff_interventionGenerateScoreToPrediction, df_v2n48_v3n36_users)) # 0.625

filter(df_v2n48_v3n36_users, !is.na(changeRelativeToOutcome_num)) %>% ggplot(aes(abs(diff_interventionTestOutcomeRG), changeRelativeToOutcome_num)) + geom_point() + geom_smooth(method=loess)

#which exceeded expectations more?

summary(lm(changeRelativeToOutcome_num ~ diff_interventionStrategyScoreExceedPrediction, df_v2n48_v3n36_users)) # 0.3352
```
...
summary(lm(directionOfChange_num ~ abs(diff_interventionTestOutcomeRG), df_v2n48_v3n36_users)) # 0.1315
summary(lm(directionOfChange_num ~ diff_interventionTestOutcomeRG, df_v2n48_v3n36_users)) # 0.0003017

filter(df_v2n48_v3n36_users, !is.na(directionOfChange_num)) %>% ggplot(aes(diff_interventionTestOutcomeRG, directionOfChange_num)) + geom_jitter(width=.15, height=.15) + geom_smooth(method=loess)

filter(df_v2n48_v3n36_users, !is.na(directionOfChange_num)) %>% ggplot(aes(diff_interventionTestOutcomeRG, directionOfChange_num)) + geom_jitter(width=.15, height=.15) + geom_smooth(method=lm)


summary(lm(directionOfChange_num ~ diff_interventionRestudyScoreToPrediction, df_v2n48_v3n36_users)) # 0.09246 TREND
summary(lm(directionOfChange_num ~ diff_interventionGenerateScoreToPrediction, df_v2n48_v3n36_users)) # n.s.
summary(lm(directionOfChange_num ~ diff_interventionRestudyScoreToPrediction + diff_interventionGenerateScoreToPrediction, df_v2n48_v3n36_users)) # 0.02332 SIG


filter(df_v2n48_v3n36_users, !is.na(directionOfChange_num)) %>% ggplot(aes(diff_interventionRestudyScoreToPrediction, directionOfChange_num)) + geom_jitter(width=.15, height=.15) + geom_smooth(method=loess)

filter(df_v2n48_v3n36_users, !is.na(directionOfChange_num)) %>% ggplot(aes(diff_interventionRestudyScoreToPrediction, directionOfChange_num)) + geom_jitter(width=.15, height=.15) + geom_smooth(method=lm)

filter(df_v2n48_v3n36_users, !is.na(directionOfChange_num)) %>% ggplot(aes(diff_interventionGenerateScoreToPrediction, directionOfChange_num)) + geom_jitter(width=.15, height=.15) + geom_smooth(method=loess)

filter(df_v2n48_v3n36_users, !is.na(directionOfChange_num)) %>% ggplot(aes(diff_interventionGenerateScoreToPrediction, directionOfChange_num)) + geom_jitter(width=.15, height=.15) + geom_smooth(method=lm)

#which exceeded expectations more?

summary(lm(directionOfChange_num ~ diff_interventionStrategyScoreExceedPrediction, df_v2n48_v3n36_users)) # 0.00615

summary(lm(directionOfChange_num ~ abs(diff_interventionStrategyScoreExceedPrediction), df_v2n48_v3n36_users)) # 0.005985

filter(df_v2n48_v3n36_users, !is.na(directionOfChange_num)) %>% ggplot(aes(diff_interventionStrategyScoreExceedPrediction, directionOfChange_num)) + geom_jitter(width=.15, height=.15) + geom_smooth(method=loess)

filter(df_v2n48_v3n36_users, !is.na(directionOfChange_num)) %>% ggplot(aes(diff_interventionStrategyScoreExceedPrediction, directionOfChange_num)) + geom_jitter(width=.15, height=.15) + geom_smooth(method=lm)


# when both are in the model...but this prob doesn't make sense since correlated
summary(lm(directionOfChange_num ~ diff_interventionTestOutcomeRG + diff_interventionStrategyScoreExceedPrediction, df_v2n48_v3n36_users)) # 0.0008947
...
summary(lm(diff_assessmentBeliefRG_num ~ abs(diff_interventionTestOutcomeRG), df_v2n48_v3n36_users)) # 0.1194
summary(lm(diff_assessmentBeliefRG_num ~ diff_interventionTestOutcomeRG, df_v2n48_v3n36_users)) # 0.008415

filter(df_v2n48_v3n36_users, !is.na(diff_assessmentBeliefRG_num)) %>% ggplot(aes(diff_interventionTestOutcomeRG, diff_assessmentBeliefRG_num)) + geom_point() + geom_smooth(method=loess)

filter(df_v2n48_v3n36_users, !is.na(diff_assessmentBeliefRG_num)) %>% ggplot(aes(diff_interventionTestOutcomeRG, diff_assessmentBeliefRG_num)) + geom_jitter() + geom_smooth(method=lm)


summary(lm(diff_assessmentBeliefRG_num ~ diff_interventionRestudyScoreToPrediction, df_v2n48_v3n36_users)) # ns
summary(lm(diff_assessmentBeliefRG_num ~ diff_interventionGenerateScoreToPrediction, df_v2n48_v3n36_users)) # ns
summary(lm(diff_assessmentBeliefRG_num ~ diff_interventionRestudyScoreToPrediction + diff_interventionGenerateScoreToPrediction, df_v2n48_v3n36_users)) # ns


filter(df_v2n48_v3n36_users, !is.na(diff_assessmentBeliefRG_num)) %>% ggplot(aes(diff_interventionRestudyScoreToPrediction, diff_assessmentBeliefRG_num)) + geom_jitter() + geom_smooth(method=loess)

filter(df_v2n48_v3n36_users, !is.na(diff_assessmentBeliefRG_num)) %>% ggplot(aes(diff_interventionRestudyScoreToPrediction, diff_assessmentBeliefRG_num)) + geom_jitter() + geom_smooth(method=lm)

filter(df_v2n48_v3n36_users, !is.na(diff_assessmentBeliefRG_num)) %>% ggplot(aes(diff_interventionGenerateScoreToPrediction, diff_assessmentBeliefRG_num)) + geom_jitter() + geom_smooth(method=loess)

filter(df_v2n48_v3n36_users, !is.na(diff_assessmentBeliefRG_num)) %>% ggplot(aes(diff_interventionGenerateScoreToPrediction, diff_assessmentBeliefRG_num)) + geom_jitter() + geom_smooth(method=lm)

#which exceeded expectations more?

summary(lm(diff_assessmentBeliefRG_num ~ diff_interventionStrategyScoreExceedPrediction, df_v2n48_v3n36_users)) # 0.4244

filter(df_v2n48_v3n36_users, !is.na(diff_assessmentBeliefRG_num)) %>% ggplot(aes(diff_interventionStrategyScoreExceedPrediction, diff_assessmentBeliefRG_num)) + geom_point() + geom_smooth(method=loess)

filter(df_v2n48_v3n36_users, !is.na(diff_assessmentBeliefRG_num)) %>% ggplot(aes(diff_interventionStrategyScoreExceedPrediction, diff_assessmentBeliefRG_num)) + geom_jitter() + geom_smooth(method=lm)
